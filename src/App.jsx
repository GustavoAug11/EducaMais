...
const QUESTOES = [
    // Matemática
    { q: 'Quanto é 15 × 4?', options: ['40', '50', '60', '70'], answer: 2, explanation: '15 × 4 = 60. Multiplique 15 por 4: 10×4=40, 5×4=20, logo 40+20=60.' },
    { q: 'Qual é a metade de 48?', options: ['22', '24', '26', '28'], answer: 1, explanation: '48 ÷ 2 = 24.' },
    { q: '3/4 equivale a quantos por cento?', options: ['50%', '65%', '70%', '75%'], answer: 3, explanation: '3 ÷ 4 = 0,75 = 75%.' },
    { q: 'Se x + 7 = 15, qual é o valor de x?', options: ['6', '7', '8', '9'], answer: 2, explanation: 'x = 15 − 7 = 8.' },
    { q: 'Quanto é 9² (nove ao quadrado)?', options: ['18', '72', '81', '99'], answer: 2, explanation: '9 × 9 = 81.' },
    { q: 'Qual fração representa 0,5?', options: ['1/3', '1/2', '2/3', '3/4'], answer: 1, explanation: '0,5 = 5/10 = 1/2.' },
    { q: 'Quanto é 25% de 200?', options: ['25', '40', '50', '75'], answer: 2, explanation: '25% de 200 = 200 × 0,25 = 50.' },
    { q: 'Qual é o resultado de 144 ÷ 12?', options: ['10', '11', '12', '14'], answer: 2, explanation: '144 ÷ 12 = 12.' },
    { q: 'Quantos lados tem um hexágono?', options: ['4', '5', '6', '7'], answer: 2, explanation: 'Hexa = seis. Um hexágono tem 6 lados.' },
    { q: 'Qual é o MMC de 4 e 6?', options: ['8', '10', '12', '24'], answer: 2, explanation: 'Múltiplos de 4: 4,8,12… Múltiplos de 6: 6,12… MMC = 12.' },
    // Português
    { q: 'Qual é o sinônimo de "alegre"?', options: ['Triste', 'Feliz', 'Cansado', 'Assustado'], answer: 1, explanation: 'Sinônimo é uma palavra com significado semelhante. "Feliz" tem o mesmo sentido de "alegre".' },
    { q: 'Em qual alternativa há um verbo no infinitivo?', options: ['Ele corre rápido.', 'Vou correr amanhã.', 'Ele correu ontem.', 'Estou correndo agora.'], answer: 1, explanation: 'O infinitivo é a forma verbal que termina em -ar, -er, -ir. "Correr" é infinitivo.' },
    { q: 'Qual frase está pontuada corretamente?', options: ['Ele comprou maçã, pão e leite', 'Ele comprou maçã pão e leite.', 'Ele comprou, maçã pão, e leite.', 'Ele comprou maçã pão, e leite'], answer: 0, explanation: 'As vírgulas devem separar itens de uma enumeração de forma clara e correta.' },
    { q: 'Qual palavra é um adjetivo?', options: ['Correr', 'Livro', 'Azul', 'Rapidamente'], answer: 2, explanation: 'Adjetivo é a palavra que qualifica um substantivo. "Azul" descreve a qualidade de algo.' },
    { q: 'Complete: "Eu ___ assistir ao filme."', options: ['gostei de', 'gosto de', 'gostaria', 'gostei'], answer: 1, explanation: 'A forma correta é "gosto de" porque o verbo "gostar" sempre é seguido pela preposição "de".' },
    { q: 'Qual é a diferença entre "mas" e "mais"?', options: ['São a mesma coisa', '"Mas" é conjunção, "mais" é adjetivo/advérbio', '"Mais" é conjunção, "mas" é substantivo', 'Não há diferença'], answer: 1, explanation: '"Mas" (conjunção) indica contraste. "Mais" (adjetivo/advérbio) indica quantidade ou intensidade.' },
    { q: 'Qual alternativa melhor completa: "Se você estudar, ___."', options: ['você falharia', 'você falhará', 'você terá êxito', 'você falhava'], answer: 2, explanation: 'Com "se" (condicional), o resultado deve estar em tempo futuro ou condicional. "Você terá êxito" é a melhor opção.' },
    { q: 'O que é um substantivo próprio?', options: ['Qualquer nome de pessoa', 'Nome de um lugar ou pessoa específica (com maiúscula)', 'Um adjetivo especial', 'Uma palavra que começa com maiúscula'], answer: 1, explanation: 'Substantivo próprio é aquele que designa um ser específico e é escrito com maiúscula inicial (ex: João, Brasil).' },
    { q: 'Em "O gato subiu no telhado", qual é o verbo?', options: ['Gato', 'Telhado', 'Subiu', 'No'], answer: 2, explanation: 'Verbo é a palavra que indica a ação. "Subiu" expressa a ação que o gato realizou.' },
    { q: 'Escolha o antônimo de "pequeno":', options: ['Minúsculo', 'Grande', 'Compacto', 'Breve'], answer: 1, explanation: 'Antônimo é uma palavra com significado oposto. "Grande" é o oposto de "pequeno".' },
];
const CONQUISTAS = [
